...
AutoArimaModel_object_five <-  Arima( y = as.vector(data_to_feed_truncated_five$y), xreg = data_to_feed_truncated_five$Age65Up, order=c(12,1,12))
...
# AutoArimaModel_object_five <-  auto.arima( y = as.vector(data_to_feed_truncated_five$y), xreg = data_to_feed_truncated_five$Age65Up )
# AutoArimaModel_object_five
...
# Min and Max
p_score_min <- min(c(arima_predictions_five_plus_original_data_Age65Up_subset$p_scores))
p_score_max <- max(c(arima_predictions_five_plus_original_data_Age65Up_subset$p_scores))
