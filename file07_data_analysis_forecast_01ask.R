...
AutoArimaModel_object_five_forecast <- forecast( AutoArimaModel_object_five, h = 4 )
...
AutoArimaModel_object_eight_forecast <- forecast( AutoArimaModel_object_eight, h = 4 )
...
# Min and Max
p_score_min <- min( c(arima_predictions_eight_plus_original_data_subset$p_scores, arima_predictions_eight_plus_original_data_subset$p_scores) )
p_score_max <- max( c(arima_predictions_eight_plus_original_data_subset$p_scores, arima_predictions_eight_plus_original_data_subset$p_scores) )
...
lower_index_five <- length(arima_predictions_five_plus_original_data_subset$p_scores) - 17
...
barplot( arima_predictions_five_plus_original_data_subset$p_scores[range_five], 
         col= c( rep("darkblue", length(arima_predictions_five_plus_original_data_subset$p_scores[range_five])-4), rep("orange", 4) ), 
         legend = TRUE, 
         border =  TRUE, 
         #xlim = c(1, 5), 
...
lower_index_eight <- length(arima_predictions_eight_plus_original_data_subset$p_scores) - 17
...
barplot( arima_predictions_eight_plus_original_data_subset$p_scores[range_eight], 
         col= c( rep("darkblue", length(arima_predictions_eight_plus_original_data_subset$p_scores[range_eight])-4), rep("orange", 4) ), 
         legend = TRUE, 
         border =  TRUE, 
         #xlim = c(1, 5), 
         ylim = c(p_score_min-5, p_score_max+10), 
...
plot(x = as.integer(arima_predictions_five_plus_original_data_subset$ds)[range_five],
...
lines(x = as.integer(arima_predictions_five_plus_original_data_subset$ds)[range_five],
      y = arima_predictions_five_plus_original_data_subset$y_hat[range_five],
      col = "darkblue",
      #col = "darkturquoise",
      # col = color_01, 
      ...
      # pch = 17,
      type = "p")
lines(x = as.integer(arima_predictions_five_plus_original_data_subset$ds)[range_five_last4],
...
lines(x = rep( max(as.integer(arima_predictions_five_plus_original_data_subset$ds)[range_five]) - 3.5 * 30, 10), 
...
plot(x = as.integer(arima_predictions_eight_plus_original_data_subset$ds)[range_eight],
...
lines(x = as.integer(arima_predictions_eight_plus_original_data_subset$ds)[range_eight],
      y = arima_predictions_eight_plus_original_data_subset$y_hat[range_eight],
      col = "darkblue",
      #col = "darkturquoise",
      # col = color_01, 
      ...
      # pch = 17,
      type = "p")
lines(x = as.integer(arima_predictions_eight_plus_original_data_subset$ds)[range_eight_last4],
...
lines(x = rep( max(as.integer(arima_predictions_eight_plus_original_data_subset$ds)[range_eight]) - 3.5 * 30, 10), 
      y = c( rep( min(value_combine), 5),  rep( max(value_combine), 5) ), 
      col="red", 
      lwd = 1, 
      lty = 2)
