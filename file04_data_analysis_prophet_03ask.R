...
pdf(paste("../Plots/Figure03a.pdf", sep = ""), height = 15, width = 15)
...
plot_point_count = 25
lower_index_five <- length(prophet_predictions_five_plus_original_data_subset$p_scores_upper) - plot_point_count
...
barplot(prophet_predictions_five_plus_original_data_subset$p_scores_upper[range_five],
      col = c(rep("darkblue", length(prophet_predictions_five_plus_original_data_subset$p_scores[range_five]) - pandemic_data_length), rep("orange", pandemic_data_length)),
      legend = TRUE,
      border = TRUE,
      # xlim = c(1, 5),
...
lower_index_eight <- length(prophet_predictions_eight_plus_original_data_subset$p_scores_upper) - plot_point_count
...
pandemic_data_length = upper_index_eight - which(prophet_predictions_eight_plus_original_data_subset$ds == pandemic_start)
...
barplot(prophet_predictions_eight_plus_original_data_subset$p_scores_upper[range_eight],
      col = c(rep("darkblue", length(prophet_predictions_eight_plus_original_data_subset$p_scores[range_eight]) - pandemic_data_length), rep("orange", pandemic_data_length)),
      legend = TRUE,
      border = TRUE,
      # xlim = c(1, 5),
      ylim = c(p_score_min - 5, p_score_max + 5),
...
plot(
      x = as.integer(prophet_predictions_eight_plus_original_data_subset$ds)[range_eight],
...
lines(
      x = as.integer(prophet_predictions_eight_plus_original_data_subset$ds)[range_eight_last4],
...
lines(
      x = rep(max(as.integer(prophet_predictions_eight_plus_original_data_subset$ds)[range_eight]) - pandemic_data_length * 30, 10),
      y = c(rep(min(value_combine), 5), rep(max(value_combine), 5)),
      col = "red",
      lwd = 1,
      lty = 2
