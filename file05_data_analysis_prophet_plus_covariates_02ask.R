...
pdf(paste("../Plots/FigureS01a.pdf", sep = ""), height = 15, width = 18)
...
barplot(prophet_predictions_five_plus_original_data_Age65Up_subset$p_scores_upper[range_five],
      col = c(rep("#005BBB", length(prophet_predictions_five_plus_original_data_Age65Up_subset$p_scores[range_five]) - pandemic_data_length), rep("#FFD500", pandemic_data_length)),
      legend = TRUE,
      border = TRUE,
      # xlim = c(1, 5),
