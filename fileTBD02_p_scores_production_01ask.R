...
# Only 2021
google_trends_grob_data_2021             <- google_trends_grob_data[ which( google_trends_grob_data$Date >= date_2021_01_01 ), ]
google_trends_pominki_data_2021          <- google_trends_pominki_data[ which( google_trends_pominki_data$Date >= date_2021_01_01 ), ]
google_trends_ritualnie_uslugi_data_2021 <- google_trends_ritualnie_uslugi_data[ which( google_trends_ritualnie_uslugi_data$Date >= date_2021_01_01 ), ]
...
# Fixing color 2020
p_scores_frame_grob_2020$color             <- c( rep("darkblue", 2), rep("orange", 10) )
p_scores_frame_pominki_2020$color          <- c( rep("darkblue", 2), rep("orange", 10) )
p_scores_frame_ritualnie_uslugi_2020$color <- c( rep("darkblue", 2), rep("orange", 10) )
...
# Fixing color 2021
p_scores_frame_grob_2021$color             <- c( rep("orange", 12) )
p_scores_frame_pominki_2021$color          <- c( rep("orange", 12) )
p_scores_frame_ritualnie_uslugi_2021$color <- c( rep("orange", 12) )
...
# First plot
lower_index_grob <- 1
upper_index_grob <- length(p_scores_frame_grob_2020_2021$p_score_value) - 4
...
upper_index_pominki <- length(p_scores_frame_pominki_2020_2021$p_score_value) - 4
...
upper_index_ritualnie_uslugi <- length(p_scores_frame_ritualnie_uslugi_2020_2021$p_score_value) - 4
