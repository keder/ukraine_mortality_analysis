...
with_year_temp <- base::merge(x = demographics_aggregated_2011_2020_transposed[, c("Year", "Age65Up")], y = merged_five, by = "Year", sort=FALSE)
...
data_to_feed_truncated_five = data_to_feed_truncated_five[order(data_to_feed_truncated_five$ds),]
...
# Fitting Arima( as.vector(data_to_feed_truncated_five$y), xreg = data_to_feed_truncated_five$Age65Up, order=c(2,0,2), include.drift = TRUE )
# Based on auto.arima settings

# AutoArimaModel_object_five <-  Arima( y = as.vector(data_to_feed_truncated_five$y), xreg = data_to_feed_truncated_five$Age65Up, order=c(2,0,2), include.drift = TRUE)
...
arima_predictions_five_plus_original_data_Age65Up_subset <- data_to_feed_full_five[order(data_to_feed_full_five$ds),]
# Saving the data as RData file.
save(arima_predictions_five_plus_original_data_Age65Up_subset, file = paste("../R_Data/arima_predictions_five_plus_original_data_Age65Up_subset.RData"))
...
with_year_temp <- base::merge(x = merged_eight, y = demographics_aggregated_2011_2020_transposed[, c("Year", "Age65Up")], by = "Year", sort=FALSE)
...
data_to_feed_truncated_eight = data_to_feed_truncated_eight[order(data_to_feed_truncated_eight$ds),]
...
AutoArimaModel_object_eight <- auto.arima(y = as.vector(data_to_feed_truncated_eight$y), xreg = data_to_feed_truncated_eight$Age65Up)
AutoArimaModel_object_eight

pandemic_data_length_eight <- dim(belarus_un_mortality_data_month_only_since_2011)[1] - which(belarus_un_mortality_data_month_only_since_2011$date_fixed == pandemic_start)
AutoArimaModel_object_eight_forecast <- forecast(AutoArimaModel_object_eight, xreg = data_to_feed_full_eight$Age65Up[(number_of_records_eight - (pandemic_data_length_eight - 1)):number_of_records_eight], h = pandemic_data_length_eight)

# Saving values
data_to_feed_full_eight$y_hat <- head(c(AutoArimaModel_object_eight$fitted, AutoArimaModel_object_eight_forecast$mean), dim(data_to_feed_full_eight)[1])
...
# Creating a sumbset with predicitons only
arima_predictions_eight_plus_original_data_Age65Up_subset <- data_to_feed_full_eight[order(data_to_feed_full_eight$ds),]
# Saving the data as RData file.
save(arima_predictions_eight_plus_original_data_Age65Up_subset, file = paste("../R_Data/arima_predictions_eight_plus_original_data_Age65Up_subset.RData"))
...
# Min and Max
p_score_min <- min(c(arima_predictions_eight_plus_original_data_Age65Up_subset$p_scores, arima_predictions_eight_plus_original_data_Age65Up_subset$p_scores))
p_score_max <- max(c(arima_predictions_eight_plus_original_data_Age65Up_subset$p_scores, arima_predictions_eight_plus_original_data_Age65Up_subset$p_scores))
...
pdf(paste("../Plots/FigureS03a.pdf", sep = ""), height = 15, width = 15)
...
plot_point_count <- 25
lower_index_five <- length(arima_predictions_five_plus_original_data_Age65Up_subset$p_scores) - plot_point_count
...
barplot(arima_predictions_five_plus_original_data_Age65Up_subset$p_scores[range_five],
      col = c(rep("darkblue", length(arima_predictions_five_plus_original_data_Age65Up_subset$p_scores[range_five]) - pandemic_data_length), rep("orange", pandemic_data_length)),
      legend = TRUE,
      border = TRUE,
      # xlim = c(1, 5),
      ...
      names.arg = arima_predictions_five_plus_original_data_Age65Up_subset$year_month_text[range_five],
      cex.names = 1.25,
      cex.lab = 2,
      cex.axis = 1.75,
      cex.main = 2,
...
plot_point_count <- 25
lower_index_eight <- length(arima_predictions_eight_plus_original_data_Age65Up_subset$p_scores) - plot_point_count
upper_index_eight <- length(arima_predictions_eight_plus_original_data_Age65Up_subset$p_scores)
range_eight <- c(lower_index_eight:upper_index_eight)
pandemic_data_length_eight <- length(arima_predictions_eight_plus_original_data_Age65Up_subset$p_scores) - which(arima_predictions_eight_plus_original_data_Age65Up_subset$ds == pandemic_start)
range_eight_last4 <- c(upper_index_eight - c(pandemic_data_length:0))

barplot(arima_predictions_eight_plus_original_data_Age65Up_subset$p_scores[range_eight],
      col = c(rep("darkblue", length(arima_predictions_eight_plus_original_data_Age65Up_subset$p_scores[range_eight]) - pandemic_data_length_eight), rep("orange", pandemic_data_length_eight)),
      legend = TRUE,
      border = TRUE,
      # xlim = c(1, 5),
      ylim = c(p_score_min - 5, p_score_max + 10),
      ...
      names.arg = arima_predictions_eight_plus_original_data_Age65Up_subset$year_month_text[range_eight],
      cex.names = 1.25,
      cex.lab = 2,
      cex.axis = 1.75,
      cex.main = 2,
...
plot(
      x = as.integer(arima_predictions_five_plus_original_data_Age65Up_subset$ds)[range_five],
      y = arima_predictions_five_plus_original_data_Age65Up_subset$y_hat[range_five],
      col = "darkblue",
      # col = color_01,
      lwd = 5,
      # pch = 16,
...
lines(
      x = as.integer(arima_predictions_five_plus_original_data_Age65Up_subset$ds)[range_five_last4],
      y = arima_predictions_five_plus_original_data_Age65Up_subset$y_hat[range_five_last4],
      # col = "darkblue",
      col = "darkorange",
      # col = color_01,
      lwd = 5,
...
lines(
      x = as.integer(arima_predictions_five_plus_original_data_Age65Up_subset$ds)[range_five],
      y = arima_predictions_five_plus_original_data_Age65Up_subset$y[range_five],
      # col = "darkblue",
      col = "darkturquoise",
      # col = color_01,
      lwd = 5,
...
lines(
      x = rep(max(as.integer(arima_predictions_five_plus_original_data_Age65Up_subset$ds)[range_five]) - pandemic_data_length_eight * 30, 10),
...
# labels FAQ -> http://www.r-bloggers.com/rotated-axis-labels-in-r-plots/
# Creating labels by month and converting.
initial_date <- min(as.integer(arima_predictions_five_plus_original_data_Age65Up_subset$ds)[range_five])
final_date <- max(as.integer(arima_predictions_five_plus_original_data_Age65Up_subset$ds)[range_five])
number_of_dates <- length(as.integer(arima_predictions_five_plus_original_data_Age65Up_subset$ds)[range_five])


# Indexes to display
# x_indexes_to_display <-  seq( from  =  1, to  = length(p_scores_frame_five_jan_june$Month),  by = 1 )
x_indexes_to_display <- arima_predictions_five_plus_original_data_Age65Up_subset$ds[range_five]
...
plot(
      x = as.integer(arima_predictions_eight_plus_original_data_Age65Up_subset$ds)[range_eight],
      y = arima_predictions_eight_plus_original_data_Age65Up_subset$y_hat[range_eight],
      col = "darkblue",
      # col = color_01,
      lwd = 5,
      # pch = 16,
...
lines(
      x = as.integer(arima_predictions_eight_plus_original_data_Age65Up_subset$ds)[range_eight_last4],
      y = arima_predictions_eight_plus_original_data_Age65Up_subset$y_hat[range_eight_last4],
      # col = "darkblue",
      col = "darkorange",
      # col = color_01,
      lwd = 5,
...
lines(
      x = as.integer(arima_predictions_eight_plus_original_data_Age65Up_subset$ds)[range_eight],
      y = arima_predictions_eight_plus_original_data_Age65Up_subset$y[range_eight],
      # col = "darkblue",
      col = "darkturquoise",
      # col = color_01,
      lwd = 5,
...
lines(
      x = rep(max(as.integer(arima_predictions_eight_plus_original_data_Age65Up_subset$ds)[range_eight]) - pandemic_data_length_eight * 30, 10),
      y = c(rep(min(value_combine), 5), rep(max(value_combine), 5)),
      col = "red",
      lwd = 1,
      lty = 2
...
# labels FAQ -> http://www.r-bloggers.com/rotated-axis-labels-in-r-plots/
# Creating labels by month and converting.
initial_date <- min(as.integer(arima_predictions_eight_plus_original_data_Age65Up_subset$ds)[range_eight])
final_date <- max(as.integer(arima_predictions_eight_plus_original_data_Age65Up_subset$ds)[range_eight])
number_of_dates <- length(as.integer(arima_predictions_eight_plus_original_data_Age65Up_subset$ds)[range_eight])


# Indexes to display
# x_indexes_to_display <-  seq( from  =  1, to  = length(p_scores_frame_five_jan_june$Month),  by = 1 )
x_indexes_to_display <- arima_predictions_eight_plus_original_data_Age65Up_subset$ds[range_eight]
# x_indexes_to_display[1] <- 1
# Actual lab elements
x_tlab <- x_indexes_to_display
# ctual lab labels
# x_lablist  <- as.character( p_scores_frame_five_jan_june$Month )
x_lablist <- as.character(arima_predictions_eight_plus_original_data_Age65Up_subset$year_month_text[range_eight])
axis(1, at = x_tlab, labels = FALSE)
text(x = x_tlab, y = par()$usr[3] - 0.03 * (par()$usr[4] - par()$usr[3]), labels = x_lablist, srt = 45, adj = 1, xpd = TRUE, cex = 1.5)
