...
p_scores_frame_five <- data.frame( Month = month.name,
...
# Creating p-scores to be saved.
p_scores_frame_eight <- data.frame( Month = month.name,
...
barplot( p_scores_frame_five_jan_june$p_score_value, col=c("darkblue", "darkblue", "orange", "orange", "orange", "orange"), 
         legend = TRUE, 
         border =  TRUE, 
         #xlim = c(1, 5), 
...
barplot( p_scores_frame_eight_jan_june$p_score_value, col=c("darkblue", "darkblue", "orange", "orange", "orange", "orange"), 
         legend = TRUE, 
         border =  TRUE, 
         #xlim = c(1, 5), 
         ylim = c(p_score_min-5, p_score_max+5), 
...
value_combine <- c(p_scores_frame_five_jan_june$Value, 
...
plot(x = as.integer(rownames(p_scores_frame_five_jan_june)),
...
lines(x = as.integer(rownames(p_scores_frame_five_jan_june)),
      y = p_scores_frame_five_jan_june$average_five_years,
      col = "darkblue",
      #col = "darkturquoise",
      # col = color_01, 
...
plot(x = as.integer(rownames(p_scores_frame_eight_jan_june)),
...
lines(x = as.integer(rownames(p_scores_frame_eight_jan_june)),
      y = p_scores_frame_eight_jan_june$average_eight_years,
      col = "darkblue",
      #col = "darkturquoise",
      # col = color_01, 
